...
//       // await VolService.deleteVol(
//       //     volId); // Assurez-vous d'avoir une fonction pour supprimer le vol
...
//                     // Text('Heure de départ: ${DateFormat('yyyy-MM-dd HH:mm').format(vol['heureDepartPrevue'])}'),
//                     Text('Statut: ${vol['status']}'),
//                     Text(
//                         'Piste: ${piste != null ? piste['pisteName'] : 'Unknown'}'),
//                     Row(
